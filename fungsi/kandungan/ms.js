...
const PRODUCT_CONTENT_MS = {
    free: {
        ...
        content: '<p style="color:#fff;font-size:0.9rem;">Setiap Pioneer wajib membaca panduan ini untuk memahami keselamatan Dompet Pi.</p>' +
            '<h4 style="color:#FFD700;margin-top:15px;">1. Kenapa Popup Passphrase Muncul?</h4>' +
            '<p style="color:#ddd;">Dompet Pi anda dilindungi oleh passphrase yang HANYA anda ketahui. Apabila anda membuat transaksi (hantar Pi), dompet perlu \'membuka kunci\' dengan passphrase untuk mengesahkan transaksi. Ini adalah mekanisme keselamatan Pi Network — BUKAN phishing.</p>' +
            '<h4 style="color:#FFD700;margin-top:15px;">2. Cara Bezakan Popup Sebenar vs Palsu</h4>' +
            ...
            '<h4 style="color:#FFD700;margin-top:15px;">3. Peraturan Keselamatan Penting</h4>' +
            '<p style="color:#ddd;">1. JANGAN kongsi passphrase dengan sesiapa — termasuk admin Pi.<br>' +
            '2. JANGAN masukkan passphrase di mana-mana laman web selain popup Dompet Pi.<br>' +
            '3. HANYA masukkan passphrase apabila anda SEDANG membuat transaksi.<br>' +
            '4. Jika ragu, TUTUP pelayar dan tanya di ruang sembang Pi rasmi.<br>' +
            '5. Simpan passphrase anda di tempat selamat — JANGAN tangkap skrin.</p>' +
            '<p style="color:#FFD700;margin-top:15px;"><strong>⚠️ Aplikasi ini TIDAK AKAN PERNAH meminta passphrase anda.</strong></p>'
    },
    echelon: {
