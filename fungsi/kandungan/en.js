const PRODUCT_CONTENT_EN = {
    free: {
        ...
        content: '<p style="color:#fff;font-size:0.9rem;">Every Pioneer must read this guide to understand Pi Wallet security.</p>' +
            '<h4 style="color:#FFD700;margin-top:15px;">1. Why Does the Passphrase Popup Appear?</h4>' +
            '<p style="color:#ddd;">Your Pi Wallet is protected by a passphrase that ONLY you know. When you make a transaction (send Pi), your wallet needs to \'unlock\' with the passphrase to confirm the transaction. This is Pi Network\'s security mechanism — NOT phishing.</p>' +
            '<h4 style="color:#FFD700;margin-top:15px;">2. How to Distinguish Real vs Fake Popup</h4>' +
            ...
            '<h4 style="color:#FFD700;margin-top:15px;">3. Important Safety Rules</h4>' +
            '<p style="color:#ddd;">1. NEVER share your passphrase with anyone — including Pi admins.<br>' +
            '2. NEVER enter your passphrase on any website other than the Pi Wallet popup.<br>' +
            '3. ONLY enter your passphrase when you ARE making a transaction.<br>' +
            '4. If in doubt, CLOSE the browser and ask in the official Pi chat.<br>' +
            '5. Store your passphrase safely — do NOT take screenshots.</p>' +
            '<p style="color:#FFD700;margin-top:15px;"><strong>⚠️ This app WILL NEVER ask for your passphrase.</strong></p>'
    },
    echelon: {
